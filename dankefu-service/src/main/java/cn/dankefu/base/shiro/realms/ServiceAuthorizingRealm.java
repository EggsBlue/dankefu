 ...
 */
@IocBean(name = "serviceRealm")
public class ServiceAuthorizingRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
            ...
            Sys_user user = userService.fetch(Cnd.where("loginname", "=", loginname).and("delFlag","=",false).and("isServiced","=",true));
    ...
    public ServiceAuthorizingRealm() {
        this(null, null);
    }

    public ServiceAuthorizingRealm(CacheManager cacheManager, CredentialsMatcher matcher) {
    ...
    public ServiceAuthorizingRealm(CacheManager cacheManager) {
        this(cacheManager, null);
    }

    public ServiceAuthorizingRealm(CredentialsMatcher matcher) {
        this(null, matcher);
    }
}